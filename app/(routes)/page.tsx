      ...
      <Container>
        ...
        <div className="space-y-10 pb-10 ">
          {billboard ? (
            ...
            <div className="relative aspect-square md:aspect-[2.4/1] bg-gradient-to-r from-sky-500 to-indigo-500 rounded-xl overflow-hidden">
        ...
        {/* About Us Section */}
        <div className="py-24 bg-gradient-to-br from-white to-gray-100">
